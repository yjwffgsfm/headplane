...
export default function CreateUser({ isOidc, isDisabled }: CreateUserProps) {
  return (
    <Dialog>
      ...
      <DialogPanel>
        <Title>创建一个 Headscale 用户</Title>
        <Text className="mb-6">
          这将在 Headscale 中创建一个新用户。该用户会出现在“未关联的 Headscale 用户”部分，直到他们
          {isOidc ? "通过你的 OIDC 提供商" : ""}登录并自动关联到 Headplane 账户。
        </Text>
        ...
        <div className="flex flex-col gap-4">
          ...
          <Input label="显示名称" name="display_name" placeholder="张三" type="text" />
